			...
			<header class="header header-fixheight header--fixed">
				<div class="container">
					<div class="header__inner">
						<div class="header-logo"><a href="home.html" id="logo-header">Basaz.ca</a></div>
							...
							<div class="hero__wrapper" style="background-image: url('assets/img/slider/1.jpg');">
								<div class="hero__inner">
									<div class="container">
										...
										<!-- btn -->
										<a class="btn btn-primary" href="#">Wanna Know How?
										</a><!-- End / btn -->
							...
							<div class="hero__wrapper" style="background-image: url('assets/img/slider/2.jpg');">
								<div class="hero__inner">
									<div class="container">
										...
										<!-- btn -->
										<a class="btn btn-primary" href="#">Call Us Now!
										</a><!-- End / btn -->
